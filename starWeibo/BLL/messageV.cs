...
namespace starweibo.BLL
{
    ...
    {
        private readonly starweibo.DAL.messageV dal = new starweibo.DAL.messageV();
        public messageV()
        { }
        #region  BasicMethod
        /// <summary>
        ...
        ///// 得到一个对象实体，从缓存中
        ///// </summary>
        //public starweibo.Model.messageV GetModelByCache(int messageId)
        //{

        //    string CacheKey = "messageVModel-" + messageId;
        ...
        //        catch { }
        //    }
        //    return (starweibo.Model.messageV)objModel;
        //}
        ...
        /// 获得数据列表
        /// </summary>
        public List<starweibo.Model.messageV> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<starweibo.Model.messageV> DataTableToList(DataTable dt)
        {
            List<starweibo.Model.messageV> modelList = new List<starweibo.Model.messageV>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                starweibo.Model.messageV model;
