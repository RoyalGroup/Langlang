...
namespace starweibo.BLL
{
    ...
    {
        private readonly starweibo.DAL.photos dal = new starweibo.DAL.photos();
        public photos()
        { }
        #region  BasicMethod
        ...
        ///// 得到一个对象实体，从缓存中
        ///// </summary>
        //public starweibo.Model.photos GetModelByCache(int id)
        //{
        ...
        //        catch { }
        //    }
        //    return (starweibo.Model.photos)objModel;
        //}
        ...
        /// 获得数据列表
        /// </summary>
        public List<starweibo.Model.photos> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<starweibo.Model.photos> DataTableToList(DataTable dt)
        {
            List<starweibo.Model.photos> modelList = new List<starweibo.Model.photos>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                starweibo.Model.photos model;
