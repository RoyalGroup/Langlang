...
namespace starweibo.DAL
{
    ...
    public partial class blogInfoV
    {
        ...
        public bool Exists(int blogId)
        {
            ...
            strSql.Append("select count(1) from blogInfoV");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into blogInfoV(");
            strSql.Append("blogContent,blogAuthorId,blogPubTime,blogId,userName,userHeadimage)");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update blogInfoV set ");
        ...
        public bool Delete(int blogId)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from blogInfoV ");
            strSql.Append(" where blogId=@blogId ");
            SqlParameter[] parameters = {
					new SqlParameter("@blogId", SqlDbType.Int,4)			};
            parameters[0].Value = blogId;
        ...
        public starweibo.Model.blogInfoV GetModel(int blogId)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 blogContent,blogAuthorId,blogPubTime,blogId,userName,userHeadimage from blogInfoV ");
            strSql.Append(" where blogId=@blogId ");
            SqlParameter[] parameters = {
					new SqlParameter("@blogId", SqlDbType.Int,4)			};
            parameters[0].Value = blogId;

            starweibo.Model.blogInfoV model = new starweibo.Model.blogInfoV();
        ...
        /// 得到一个对象实体
        /// </summary>
        public starweibo.Model.blogInfoV DataRowToModel(DataRow row)
        {
            starweibo.Model.blogInfoV model = new starweibo.Model.blogInfoV();
            if (row != null)
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select blogContent,blogAuthorId,blogPubTime,blogId,userName,userHeadimage ");
            strSql.Append(" FROM blogInfoV ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from blogInfoV T ");
