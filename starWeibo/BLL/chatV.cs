...
namespace starweibo.BLL
{
    ...
    {
        private readonly starweibo.DAL.chatV dal = new starweibo.DAL.chatV();
        public chatV()
        { }
        #region  BasicMethod
        /// <summary>
        ...
        //        catch { }
        //    }
        //    return (starweibo.Model.chatV)objModel;
        //}
        ...
        /// 获得数据列表
        /// </summary>
        public List<starweibo.Model.chatV> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<starweibo.Model.chatV> DataTableToList(DataTable dt)
        {
            List<starweibo.Model.chatV> modelList = new List<starweibo.Model.chatV>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                starweibo.Model.chatV model;
