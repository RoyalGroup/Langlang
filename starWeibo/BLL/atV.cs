...
namespace starweibo.BLL
{
    ...
    {
        private readonly starweibo.DAL.atV dal = new starweibo.DAL.atV();
        public atV()
        { }
        #region  BasicMethod
        /// <summary>
        ...
        ///// 得到一个对象实体，从缓存中
        ///// </summary>
        //public starweibo.Model.atV GetModelByCache(int blogId)
        //{

        //    string CacheKey = "atVModel-" + blogId;
        ...
        //        catch { }
        //    }
        //    return (starweibo.Model.atV)objModel;
        //}
        ...
        /// 获得数据列表
        /// </summary>
        public List<starweibo.Model.atV> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<starweibo.Model.atV> DataTableToList(DataTable dt)
        {
            List<starweibo.Model.atV> modelList = new List<starweibo.Model.atV>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                starweibo.Model.atV model;
