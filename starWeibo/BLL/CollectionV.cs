...
namespace starweibo.BLL
{
    ...
    {
        private readonly starweibo.DAL.CollectionV dal = new starweibo.DAL.CollectionV();
        public CollectionV()
        { }
        #region  BasicMethod
        /// <summary>
        ...
        ///// 得到一个对象实体，从缓存中
        ///// </summary>
        //public starweibo.Model.CollectionV GetModelByCache(int messageId)
        //{

        //    string CacheKey = "CollectionVModel-" + messageId;
        ...
        //        catch { }
        //    }
        //    return (starweibo.Model.CollectionV)objModel;
        //}
        ...
        /// 获得数据列表
        /// </summary>
        public List<starweibo.Model.CollectionV> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<starweibo.Model.CollectionV> DataTableToList(DataTable dt)
        {
            List<starweibo.Model.CollectionV> modelList = new List<starweibo.Model.CollectionV>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                starweibo.Model.CollectionV model;
