...
namespace starweibo.BLL
{
    ...
    {
        private readonly starweibo.DAL.powerInfo dal = new starweibo.DAL.powerInfo();
        public powerInfo()
        { }
        #region  BasicMethod
        ...
        ///// 得到一个对象实体，从缓存中
        ///// </summary>
        //public starweibo.Model.powerInfo GetModelByCache(int id)
        //{

        //    string CacheKey = "powerInfoModel-" + id;
        ...
        //        catch { }
        //    }
        //    return (starweibo.Model.powerInfo)objModel;
        //}
        ...
        /// 获得数据列表
        /// </summary>
        public List<starweibo.Model.powerInfo> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<starweibo.Model.powerInfo> DataTableToList(DataTable dt)
        {
            List<starweibo.Model.powerInfo> modelList = new List<starweibo.Model.powerInfo>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                starweibo.Model.powerInfo model;
