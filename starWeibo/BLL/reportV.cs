...
namespace starweibo.BLL
{
    ...
    {
        private readonly starweibo.DAL.reportV dal = new starweibo.DAL.reportV();
        public reportV()
        { }
        #region  BasicMethod
        /// <summary>
        ...
        ///// 得到一个对象实体，从缓存中
        ///// </summary>
        //public starweibo.Model.reportV GetModelByCache(int messageId)
        //{

        //    string CacheKey = "reportVModel-" + messageId;
        ...
        //        catch { }
        //    }
        //    return (starweibo.Model.reportV)objModel;
        //}
        ...
        /// 获得数据列表
        /// </summary>
        public List<starweibo.Model.reportV> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<starweibo.Model.reportV> DataTableToList(DataTable dt)
        {
            List<starweibo.Model.reportV> modelList = new List<starweibo.Model.reportV>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                starweibo.Model.reportV model;
