...
namespace starweibo.BLL
{
    ...
    {
        private readonly starweibo.DAL.userInfo dal = new starweibo.DAL.userInfo();
        public userInfo()
        { }
        #region  BasicMethod
        ...
        ///// 得到一个对象实体，从缓存中
        ///// </summary>
        //public starweibo.Model.userInfo GetModelByCache(int id)
        //{
        ...
        //        catch { }
        //    }
        //    return (starweibo.Model.userInfo)objModel;
        //}
        ...
        /// 获得数据列表
        /// </summary>
        public List<starweibo.Model.userInfo> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<starweibo.Model.userInfo> DataTableToList(DataTable dt)
        {
            List<starweibo.Model.userInfo> modelList = new List<starweibo.Model.userInfo>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                starweibo.Model.userInfo model;
